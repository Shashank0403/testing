...
def login(request):
    ...
    if request.method == 'POST':
        text1 = "Welcome to our Voice Based Email. Please provide your login credentials inorder to continue. "
        ...
        try:
            ...
            texttospeech("You have logged in successfully. You will now be redirected to the menu page.", file + i)
            i = i + str(1)
